...
plot!(iters, vec(median(err_cov_sp, dims=1)), label = names[5], color = colours[5], ribbon = get_percentiles(err_cov_sp), guidefontsize=20, tickfontsize=15, margin=5mm, formatter=:plain, legend=false)
xlabel!("iteration")
ylabel!("rel cov err")
...
plot!(iters, vec(median(ksd_sp, dims=1)), label = names[5], color = colours[5], ribbon = get_percentiles(ksd_sp), guidefontsize=20, tickfontsize=15, margin=5mm, formatter=:plain, legend=:topright, legendfontsize=15)
xlabel!("iteration")
ylabel!("KSD")
