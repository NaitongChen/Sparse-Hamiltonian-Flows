...
plot!(Ms, vec(median(KL_sp, dims=1)), label = names[3], color = colours[3], ribbon = get_percentiles(KL_sp), legend = (0.55, 0.5), yscale = :log10, guidefontsize=20, tickfontsize=15, margin=5mm, formatter=:plain, legendfontsize=15)
ylabel!("KL")
xlabel!("coreset size")
...
plot!(Ms, vec(median(mrel_sp, dims=1)), label = names[3], color = colours[3], ribbon = get_percentiles(mrel_sp), guidefontsize=20, tickfontsize=15, margin=5mm, formatter=:plain, legend=false)
ylabel!("rel mean err")
xlabel!("coreset size")
...
plot!(Ms, vec(median(srel_sp, dims=1)), label = names[3], color = colours[3], ribbon = get_percentiles(srel_sp), legend = false, yscale = :log10, guidefontsize=20, tickfontsize=15, margin=5mm, formatter=:plain)
ylabel!("rel cov err")
xlabel!("coreset size")
...
plot!(Ms, vec(median(slogrel_sp, dims=1)), label = names[3], color = colours[3], ribbon = get_percentiles(slogrel_sp), legend = :topright, guidefontsize=20, tickfontsize=15, margin=5mm, formatter=:plain, legendfontsize=15)
...
plot!(Ms, vec(median(KSD_sp, dims=1)), label = names[3], color = colours[3], ribbon = get_percentiles(KSD_sp), legend = false, guidefontsize=20, tickfontsize=15, margin=5mm, formatter=:plain)
ylabel!("KSD")
xlabel!("coreset size")
